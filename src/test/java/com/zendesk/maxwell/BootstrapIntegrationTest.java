...
public class BootstrapIntegrationTest extends AbstractMaxwellTest {
	...
	@Test
		...
		String expectedJSON[] = {
			...
			"{\"database\":\"maxwell\",\"table\":\"bootstrap\",\"type\":\"insert\",\"ts\":0,\"xid\":0,\"commit\":true,\"data\":{\"id\":0,\"database_name\":\"shard_1\",\"table_name\":\"minimal\",\"is_complete\":0}}",
			...
			"{\"database\":\"maxwell\",\"table\":\"bootstrap\",\"type\":\"update\",\"ts\":0,\"xid\":0,\"commit\":true,\"data\":{\"id\":0,\"database_name\":\"shard_1\",\"completed_at\":\"\",\"table_name\":\"minimal\",\"started_at\":\"\",\"is_complete\":1}}",
		...
		for (int i = 0; i < expectedJSON.length; ++i) {
			assertThat(removeTimeStampsAndIds(list.get(i).toJSON()), is(expectedJSON[i]));
		}
	}
	...
	private void testColumnType(String sqlType, String sqlValue, String expectedNormalJsonValue, String expectedBootstrappedJsonValue) throws Exception {
		...
		String expectedJSON[] = {
			...
			"{\"database\":\"maxwell\",\"table\":\"bootstrap\",\"type\":\"insert\",\"ts\":0,\"xid\":0,\"commit\":true,\"data\":{\"id\":0,\"database_name\":\"shard_1\",\"table_name\":\"column_test\",\"is_complete\":0}}",
			...
			"{\"database\":\"maxwell\",\"table\":\"bootstrap\",\"type\":\"update\",\"ts\":0,\"xid\":0,\"commit\":true,\"data\":{\"id\":0,\"database_name\":\"shard_1\",\"completed_at\":\"\",\"table_name\":\"column_test\",\"started_at\":\"\",\"is_complete\":1}}",
