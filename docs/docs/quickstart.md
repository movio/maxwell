...
```
curl -sLo - https://github.com/zendesk/maxwell/releases/download/v0.15.0-bootstrapping-bootstrapping-bootstrapping-bootstrapping-RC1/maxwell-0.15.0-bootstrapping-bootstrapping-bootstrapping-bootstrapping-RC1.tar.gz \
       | tar zxvf -
cd maxwell-0.15.0-bootstrapping-bootstrapping-bootstrapping-bootstrapping-RC1
```
